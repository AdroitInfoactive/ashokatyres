...
<div class="page-content bg-white">
  ...
  <!-- <form name="frmadrs" id="frmadrs" method="post" action="<?php $_SERVER['SCRIPT_NAME'];?>"> -->
    <form name="cart" id="cart" method="post"  action="manage_cart.php?cartaction=u&typ=<?php echo $action; ?>">
	...
	// new code cart calculation ends
                        ...
                        <div>
                          <div class="row d-flex justify-content-between">
                            <div class="col-lg-8 col-md-8">
                              ...
                              <p class="mb-2  text-uppercase small"><strong>Tyre Brand</strong> -
                                <?php echo $crtprodtyrbrndnm ?></p>
      ...
      $moq=1;
		 ...
		 $clsbls = $prdinvt; ?>
                            <input type="hidden" value="<?php echo $crtvechbrndid ?>"
                              id="vechbrndnid<?php echo $crtprodid ?>">
                            <div class="col-lg-4 col-md-4">
                              <div class="d-flex">
                                <div class="number">

                                <button class="minus"
                                    onclick="this.parentNode.querySelector('input[type=number]').stepDown(); cart.submit();"><i
                                        class="fa fa-minus" aria-hidden="true"></i></button>
                                <input class="quantity" min="<?php echo $moq; ?>"
                                    name="quantity<?php echo $crtprodid; ?>"
                                    id="quantity<?php echo $crtprodid; ?>"
                                    value="<?php echo $untqty; ?>" type="number"
                                    onBlur="chkminordqty(<?php echo $crtprodid; ?>);" readonly>
                                <button class="plus"
                                    onclick="this.parentNode.querySelector('input[type=number]').stepUp(); cart.submit();"><i
                                        class="fa fa-plus" aria-hidden="true"></i></button>
                                  <!-- <button class="minus" id="qntyinc<?php echo $crtprodid ?>"
                                    onclick="cuntdec(<?php echo $untqty?>,<?php echo $crtprodid?>,<?php echo $clsbls?>)">-</button>
                                  ...
                                  <button class="plus" id="qntydec<?php echo $crtprodid ?>"
                                    onclick="cuntinc(<?php echo $untqty?>,<?php echo $crtprodid?>,<?php echo $clsbls?>,<?php echo $cntinc?>)">+</button> -->
                                </div>
                              </div>
                              <small id="passwordHelpBlock w-100" class="form-text text-muted text-center">
                                (Quantity)
                              </small>
                            </div>
                          </div>
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="rm-wslists">
                              <a type="button" onclick="funbDeletProd(<?php echo  $cartcodeid ;?>)"
                                class="card-link-secondary small text-capitalize mr-10px"><i
                                  class="fas fa-trash-alt mr-1"></i> Remove item </a>
                              <a type="button" onclick="funprod(<?php echo  $crtprodid ;?>)"
                                class="card-link-secondary small text-capitalize"><i class="fas fa-heart mr-1"></i> Move
                                to wish list </a>
                ...
                <!-- <div class="mb-3">
                  ...
                  <div class="dl-option d-flex mt-4">
                    <div class=" mb-2 mr-2">
                      <input type="radio" name="crtaddrsts" id="addrd" value="d" onclick="funChsdeltyp('d')"
                        checked /><label for="addrd"><strong> Online Delivery</strong></label>
                    </div>
                    <div class=" mb-2 mr-2">
                      <input type="radio" name="crtaddrsts" id="addrdf" value="df" onclick="funChsdeltyp('df')" />
                      <label for="addrdf"><strong>Doorstep Fitting</strong></label>
                    </div>
                    <div class=" mb-2 mr-2 dropdown">
                      <input type="radio" name="crtaddrsts" id="addrfs" value="fs" onclick="funChsdeltyp('s')" /> <label
                        for="addrfs"><strong>Fitting At Store</strong></label>
                    </div>
                  </div>
                </div> -->
                <!-- <div class="row mult-addr" id="chkdeladd">
                  <div class="pt-4">
                    <h6 id="dchrg">Devilery Charges : 150 /- rs
                      <input type="hidden" name="txtdevlrychrg" id="txtdevlrychrg" value="150" />
                    </h6>
                  ...
                  <div class="col-md-12 ">
                    <div class="singl-add">
                      <input type="radio" name="addchk" value="<?php echo $mbrid;?>" id="chk<?php echo $mbrid;?>"
                        <?php if($billsts =='y'){echo 'checked';}else{echo '';} ?> />
              ...
              <div class="col-lg-4">
                <!-- Card -->
                  ...
                  <div class="clearfix">
                    ...
                    <a href="<?php $rtpth?>checkout.php"
                      class="mt-3 view-details-btn btn btn-primary light phone-no shadow-none effect-1 w-100 text-center d-block"><span>Proceed to checkout</span></a>
                    </div>

                    <!-- <div> <a href="<?php echo $rtpth; ?>checkout.php">Proceed to checkout</a>
                    </div> -->
                      <!-- <button type="submit" name="btnSbmt" id="btnSbmt" value="Confirm Order"
                        class=" view-details-btn btn btn-primary light phone-no shadow-none effect-1 w-100 text-center d-block p-5" /><span>Confirm
                        Order</span></button> -->
                      <?php }else{ ?> <a href="<?php $rtpth?>signin"
                        class="mt-3 view-details-btn btn btn-primary light phone-no shadow-none effect-1 w-100 text-center d-block"><span>Login
                ...
                <!-- <div class="mb-3">
                  <div class="pt-4">
                    ...
                    <a class="dark-grey-text d-flex justify-content-between" data-bs-toggle="collapse"
...
<!-- <script type="text/javascript">
        ...
        debugger;
				if (crtactn == 'u') {
					var qtyval = document.getElementById("txtqty<?php echo $crtprodid?>").value;
