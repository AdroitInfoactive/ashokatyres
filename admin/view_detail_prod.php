			...
			<div class="card-body">
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<div class="form-group row">
							<label for="txtname" class="col-sm-2 col-md-3 col-form-label">Product Features</label>
							<div class="col-sm-8">
								<?php
								$sqryfet = "SELECT prodfetrm_name from prodfetr_mst
									inner join prod_features_dtl on prod_features_dtl.prods_fetrs_store_id = prodfetr_mst.prodfetrm_id where prods_fetrs_prodm_id = $id";
								 //echo $sqryfet;
