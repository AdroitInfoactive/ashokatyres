...
/***************************************************************
Programm : view_detail_custmer_views.php	
Purpose : For Viewing custmer_views Details
...
$sqrycust_views_mst = "SELECT custmer_name, custmer_desc, custmer_lnk, if(custmer_sts = 'a', 'Active','Inactive') as custmer_sts, custmer_prty, custmer_imgnm 
	from cust_views_mst where custmer_id = $id";
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">View custmer views</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">View custmer views</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
				...
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php echo $rowscust_views_mst['custmer_prty'];?>
							</div>
						</div>
						<div class="form-group row">
							<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Status</label>
							<div class="col-sm-8"> 
								<?php echo $rowscust_views_mst['custmer_sts'];?>
							</div>
						</div>
						<p class="text-center">
