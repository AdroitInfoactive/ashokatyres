...
/***********************************************************
Programm : add_ordsts.php	
Package : 
Purpose : For add Order Status details
Created By : Bharath
...
{
	include_once "../database/iqry_ordsts_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?ordstsnm="+name;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add Order Status</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
	...
	<div class="card">
		...
		<div class="card-body p-0">
			<form name="frmaddordsts" id="frmaddordsts" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddordsts', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnordstssbmt" id="btnordstssbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
