							...
							<div class="row justify-content-center align-items-center">
								...
								<div class="col-md-12">
									<div class="row mb-2 mt-2">
										...
										<?php
											$sqrystr_prod_fet_mst = "SELECT prodfetrm_id, prodfetrm_name,prodfetrm_sts from  prodfetr_mst where prodfetrm_sts='a'  order by prodfetrm_name ";
											$srsstrfet_mst = mysqli_query($conn,$sqrystr_prod_fet_mst);
											$cnt_str_loc = mysqli_num_rows($srsstrfet_mst);
										?>
										<div class="col-sm-9">
											<?php
											while ($rowsstr_fetures_mst = mysqli_fetch_array($srsstrfet_mst))
											{ ?>
												<input name="ckhfetrs[]" type="checkbox" id="ckhfetrs" value="<?php echo $rowsstr_fetures_mst["prodfetrm_id"]; ?>">&nbsp;<?php echo $rowsstr_fetures_mst["prodfetrm_name"]; ?>
