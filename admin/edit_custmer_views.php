...
/**********************************************************
Programm : edit_custmer_views.php 
Purpose : For Editing custmer_views
...
if(isset($_POST['btnebnrsbmt']) && (trim($_POST['btnebnrsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != ""))
{
	...
	include_once "../database/uqry_custmer_views_mst.php";
}
...
$sqrycust_views_mst = "SELECT custmer_name, custmer_desc, custmer_sts, custmer_prty, custmer_lnk, custmer_imgnm from cust_views_mst where custmer_id = $id";
$srscust_views_mst = mysqli_query($conn,$sqrycust_views_mst);
$cntrec = mysqli_num_rows($srscust_views_mst);
if($cntrec > 0)
{
	$rowscust_views_mst = mysqli_fetch_assoc($srscust_views_mst);
}
else
{ ?>
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Edit Custmer Views</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Edit Custmer Views</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	...
	<form name="frmedtbnrid" id="frmedtbnrid" method="post" action="<?php $_SERVER['PHP_SELF'];?>" onSubmit="return performCheck('frmedtbnrid', rules, 'inline');" enctype="multipart/form-data">
		...
		<input type="hidden" name="hdnbnrimg" id="hdnbnrimg" value="<?php echo $rowscust_views_mst['custmer_imgnm'];?>">
		<div class="card">
			<div class="card-body">
				<div class="row justify-content-center align-items-center">
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9">
								<input name="txtname" type="text" id="txtname" size="45" maxlength="40" onBlur="funcChkDupName()" class="form-control" value="<?php echo $rowscust_views_mst['custmer_name']; ?>">
					...
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9"> 
								<textarea name="txtdesc" cols="60" rows="3" id="txtdesc" class="form-control"><?php echo $rowscust_views_mst['custmer_desc']; ?></textarea>
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9">
								...
								<?php
								$bnrimgnm = $rowscust_views_mst['custmer_imgnm'];
					...
					<!-- <div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9"> 
								<input type="text" name="txtlnk" id="txtlnk" size="45" maxlength="250" class="form-control" value="<?php echo $rowscust_views_mst['custmer_lnk']; ?>">
							</div>
						</div>
					</div> -->
					<div class="col-md-12">
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9"> 
								<input type="text" name="txtprior" id="txtprior" class="form-control" size="4" maxlength="3" value="<?php echo $rowscust_views_mst['custmer_prty']; ?>">
						...
						<div class="row mb-2 mt-2">
							...
							<div class="col-sm-9">
								<select name="lststs" id="lststs" class="form-control">
									<option value="a"<?php if($rowscust_views_mst['custmer_sts']=='a') echo 'selected';?>>Active</option>
									<option value="i"<?php if($rowscust_views_mst['custmer_sts']=='i') echo 'selected';?>>Inactive</option>
								</select>
