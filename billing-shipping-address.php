                ...
                ?>
                  <div class="col-lg-6 col-md-6">
                    <div class="add-mul">
                      ...
                      <div class="row">
                        <div class="col-4  "> <a href="#" class=" custom-btns-bot" data-toggle="modal" data-target="#exampleModal<?php echo $mbrid ?>"><span><i class="far fa-edit mr-2"></i>Edit </span></a></div>
                      ...
                      <!-- Modal -->
                      <div class="modal fade" id="exampleModal<?php echo $mbrid ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <form name="frmedtdtls" id="frmedtdtls" method="post" onSubmit="return performCheck('frmedtdtls',snrules,'inline');" enctype="multipart/form-data">
                                <div class="row">
                                  ...
                                  <div class="col-lg-4 col-md-4 form-group">
                                    ...
                                    <input type="text" id="txtphno<?php echo $mbrid ?>" name="txtphno<?php echo $mbrid ?>" value="<?php echo $mbrphno ?>" class="form-control">
                                  ...
                                  <div class="col-lg-4 col-md-4 form-group">
                                    ...
                                    <select name="lstcntry<?php echo $mbrid ?>" id="lstcntry<?php echo $mbrid ?>" class="form-control" onchange="funcPopCnty()">
                                      <option value="2" selected=""> India</option>
                                    </select>
                                  </div>
                                  <div class="col-lg-4 col-md-4 form-group">
                                    <label for="">State</label>
                                    <select name="lststate<?php echo $mbrid ?>" id="lststate<?php echo $mbrid ?>" class="form-control">
						   ...
						   group by 
							...
							order by 
								 cntym_name";
                                      ...
                                      ?>
                                        <option value="<?php echo $cntymid ?>" <?php if ($cntymid == $mbrstateid) {
                                                                                  echo 'selected';
                                                                                } else {
                                                                                  echo '';
                                  ...
                                  <div class="col-lg-4 col-md-4 form-group">
                                    ...
                                    <input type="text" id="txtcty<?php echo $mbrid ?>" name="txtcty<?php echo $mbrid ?>" value="<?php echo $mbrctynm; ?>" class="form-control">
                                    <span id="errorsDiv_txtcty<?php echo $mbrid ?>"></span>
                                  </div>
                                  <div class="col-lg-4 col-md-4 form-group">
                                    <label for="">Pin Code</label>
                                    <input type="text" id="txtpin<?php echo $mbrid ?>" name="txtpin<?php echo $mbrid ?>" value="<?php echo $mbrzip; ?>" class="form-control">
                                    <span id="errorsDiv_txtpin<?php echo $mbrid ?>"></span>
                                  </div>
                                  <div class="col-lg-4 col-md-4 form-group">
                                    <label for="">Status</label>
                                    <select name="lssts<?php echo $mbrid ?>" id="lssts<?php echo $mbrid ?>" class="form-control">
                                      <option value="y" <?php if ($billsts == 'y') {
                                                          echo 'selected';
                                                        } else {
                                                        } ?>> Active</option>
                                      <option value="n" <?php if ($billsts == 'n') {
                                                          echo 'selected';
                                                        } else {
                                                        } ?>> Inactive </option>
                                    </select>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12 m-b30">
                  <div class="car-list-box list-view">
                    <div class="media-box"> <img src="images/product/grid/pic1.jpg" alt="">
                      ...
                      <div class="overlay-bx"> <span data-exthumbimage="images/product/grid/pic1.jpg" data-src="images/product/grid/pic1.jpg" class="view-btn lightimg"> </span> </div>
                    </div>
                    <div class="list-info">
                      <h6 class="title mb-0"><a href="product-display.php" data-splitting class="text-white">Goodyear 205/55 R16 Eagle NCT5 91V Tubeless Car
                          Tyre</a></h6>
                      <div class="car-type">Sku: CE2356517ZATL</div>
                      <div class="d-flex justify-content-between align-items-center"> <span class="badge m-b10 mr-rt-5"><span>₹</span>8,299.00</span> <a href="product-display.php" class="m-b10 view-details-btn btn btn-primary light phone-no shadow-none effect-1 w-100 text-center d-block"><span><i class="fas fa-cart-plus"></i></span></a> </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12 m-b30">
                  <div class="car-list-box list-view">
                    <div class="media-box"> <img src="images/product/grid/pic2.jpg" alt="">
                      <div class="rm-wsh"><a href=""><i class="fas fa-times"></i></a></div>
                      <div class="overlay-bx"> <span data-exthumbimage="images/product/grid/pic2.jpg" data-src="images/product/grid/pic1.jpg" class="view-btn lightimg"> </span> </div>
                    </div>
                    <div class="list-info">
                      <h6 class="title mb-0"><a href="product-display.php" data-splitting class="text-white">Goodyear 205/55 R16 Eagle NCT5 91V Tubeless Car
                          Tyre</a></h6>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-12 m-b30">
                  <div class="car-list-box list-view">
                    <div class="media-box"> <img src="images/product/grid/pic3.jpg" alt="">
                      <div class="rm-wsh"><a href=""><i class="fas fa-times"></i></a></div>
                      <div class="overlay-bx"> <span data-exthumbimage="images/product/grid/pic3.jpg" data-src="images/product/grid/pic1.jpg" class="view-btn lightimg"> </span> </div>
                    </div>
                    <div class="list-info">
                      <h6 class="title mb-0"><a href="product-display.php" data-splitting class="text-white">Goodyear 205/55 R16 Eagle NCT5 91V Tubeless Car
                          Tyre</a></h6>
                      ...
                      <div class="">
                        <div class="accordion-body car-body">
                          ...
                          <form name="frmchngpwd" id="frmchngpwd" method="post" class="row mb-0" onSubmit="return performCheck('frmchngpwd',chngpwd,'inline');" enctype="multipart/form-data">
                            ...
                            <div class="col-12 form-group d-flex justify-content-start chnge-pas">
                              <input type="submit" class="btn btn-primary " id="btnchngpwd" name="btnchngpwd" value="Update">
                              <button class="btn btn-secondary m-0" id="login-form-submit" name="login-form-submit" value="login">Reset</button>
                            </div>
                          </form>
                        </div>
                      </div>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Yes</td>
                      <td align="center"><a class="btn btn-primary btn-sm text-white">Delivered</a></td>
