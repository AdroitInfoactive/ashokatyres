...
<tr class="mb-2">
<div class="row mb-4">
<td class="ps-product__thumbnail"><figure><img src="<?php echo  $smlImgPth; ?>" width="100px" height="100px"></figure> </td>
...
<div class="ps-shopping__button mb-4">
  <a href="<?php echo $rtpth;?>cart"><button class="ps-btn ps-btn--primary" type="button">Edit / Remove</button></a></div>
</div>
...
<div class=" mb-2 mr-2">
<input type="radio" name="crtaddrsts" id="addrd" value="d"
onclick="funChsdeltyp('d')" checked /><label for="addrd"><strong> Online
Delivery</strong></label>
</div>
<div class=" mb-2 mr-2">
<input type="radio" name="crtaddrsts" id="addrdf" value="df"
onclick="funChsdeltyp('df')" />
<label for="addrdf"><strong>Doorstep Fitting</strong></label>
</div>
<div class=" mb-2 mr-2 dropdown">
<input type="radio" name="crtaddrsts" id="addrfs" value="fs"
onclick="funChsdeltyp('s')" /> <label for="addrfs"><strong>Fitting At
Store</strong></label>
</div>
</div>
</div>
...
<div class="col-md-12 ">
<div class="singl-add">
<input type="radio" name="addchk" value="<?php echo $mbrid;?>"
id="chk<?php echo $mbrid;?>"
...
<select class="form-select" id="strloc" name="strloc"
...
class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0">
Charges
<span id="charges_od" style="display:block">₹<?php  if($od > 0){echo $chrg= $od ;}else{
echo '0.00';}; ?></span>
</li> -->
...
Total Cart Value
<span>₹<?php  if($totcartprc >0 && $od>0){echo $totcartprc + $chrg ; }else{
echo '0.00';}; ?></span>
</li>
<li
class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
<div>
<input type="hidden" name="ntTogPrc" id="ntTogPrc"
	value="<?php echo $totcartprc; ?>" />
<strong>The total amount of</strong>
<strong>
	<p class="mb-0">(including GST)</p>
</strong>
</div>
<span><strong>₹<?php  if($totcartprc >0){echo $totcartprc + $chrg; }else{
